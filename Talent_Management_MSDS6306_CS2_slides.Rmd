...
ggplot(df_plot_wl) +
  ...
  geom_bar(aes(x=WorkLifeBal, y=pct_of, label=pct_of), stat='identity', fill="Red") +
  labs(title="Attrition by Work-Life Balance",
       subtitle="Frequency with Attrition Portion (Labelled) Highlighted",
...
- Insights:  The Agency 
  ...
  - As per research, this rate is higher than peer companies at 15.3%
  - As per the data, there is a significant percentage of employees in the company are disengaged
...
## Executive Summary PT 3 {.smaller}
<div class="centered">
![](image/improve.jpg)
</div>
